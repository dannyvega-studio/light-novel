...
import CarouselELAINA from '../../components/Carousel/CarouselELAINA';
import elaina01 from '../../assets/images/elaina/01.jpg';
import elaina02 from '../../assets/images/elaina/02.jpg';
import elaina03 from '../../assets/images/elaina/03.jpg';
import elaina04 from '../../assets/images/elaina/04.png';
export {elaina01, elaina02, elaina03, elaina04 };

function LNElaina(props) {

    const Titulo = "Majo no Tabitabi"
    const linkNav = "elaina"
        ...
        <div>
            ...
            <Container className="bg-white border" fluid={true}>
                <Row className="justify-content-center py-5">
                    ...
                    <Col lg={6} sm={12}>
                        <h2 className="mt-2">Anime: <a href="https://www3.animeflv.net/anime/majo-no-tabitabi" target="_blank"><h4>1er Temporada</h4></a></h2>
                        <h2 className="mt-4">Genero: <h4>Fantasía, Aventura</h4></h2>
                        <h2 className="mt-4">Traductor: <a href="https://shinsengumitranslations.wordpress.com/" target="_blank"><h4>Shinsengumi Translations</h4></a></h2>
                    ...
                    <Col lg={3} md={4} sm={6} xs={6}>
                        <ModalImage className="ln-cover" small={elaina04} large={elaina04} alt={`${Titulo} Volumen 04`} />
                        <Card.Body>
                    ...
                    <Col lg={3} md={4} sm={6} xs={6}>
                        <ModalImage className="ln-cover" small={elaina03} large={elaina03} alt={`${Titulo} Volumen 03`} />
                        <Card.Body>
                    ...
                    <Col lg={3} md={4} sm={6} xs={6}>
                        <ModalImage className="ln-cover" small={elaina02} large={elaina02} alt={`${Titulo} Volumen 02`} />
                        <Card.Body>
                    ...
                    <Col lg={3} md={4} sm={6} xs={6}>
                        <ModalImage className="ln-cover" small={elaina01} large={elaina01} alt={`${Titulo} Volumen 01`} />
                        <Card.Body>
