...
import CarouselKYAKKO from '../../components/Carousel/CarouselKYAKKO';
import kyakko01 from '../../assets/images/konosuba/kyakko/01.jpg';
import kyakko02 from '../../assets/images/konosuba/kyakko/02.jpg';
import kyakko03 from '../../assets/images/konosuba/kyakko/03.jpg';
import kyakko04 from '../../assets/images/konosuba/kyakko/04.jpg';
import kyakko05 from '../../assets/images/konosuba/kyakko/05.jpg';
import kyakko06 from '../../assets/images/konosuba/kyakko/06.jpg';
import kyakko07 from '../../assets/images/konosuba/kyakko/07.jpg';
export {kyakko01, kyakko02, kyakko03, kyakko04, kyakko05, kyakko06}

function SOKyakko(props) {

    const Titulo = "Ano Orokamono ni mo Kyakkou wo!"
    const linkNav = "kyakko"
            ...
            <Container className="bg-white border">
                <Row className="justify-content-center py-5">
                    ...
                    <Col lg={3} md={4} sm={6} xs={6}>
                        <ModalImage className="ln-cover" small={kyakko06} large={kyakko06} alt={`${Titulo} Volumen 06`} />
                        <Card.Body>
                    ...
                    <Col lg={3} md={4} sm={6} xs={6}>
                        <ModalImage className="ln-cover" small={kyakko05} large={kyakko05} alt={`${Titulo} Volumen 05`} />
                        <Card.Body>
                    ...
                    <Col lg={3} md={4} sm={6} xs={6}>
                        <ModalImage className="ln-cover" small={kyakko04} large={kyakko04} alt={`${Titulo} Volumen 04`} />
                        <Card.Body>
                    ...
                    <Col lg={3} md={4} sm={6} xs={6}>
                        <ModalImage className="ln-cover" small={kyakko03} large={kyakko03} alt={`${Titulo} Volumen 03`} />
                        <Card.Body>
                    ...
                    <Col lg={3} md={4} sm={6} xs={6}>
                        <ModalImage className="ln-cover" small={kyakko02} large={kyakko02} alt={`${Titulo} Volumen 02`} />
                        <Card.Body>
                    ...
                    <Col lg={3} md={4} sm={6} xs={6}>
                        <ModalImage className="ln-cover" small={kyakko01} large={kyakko01} alt={`${Titulo} Volumen 01`} />
                        <Card.Body>
