...
import CarouselBAKUENZUKKO from '../../components/Carousel/CarouselBAKUENZUKKO';
import bakuenzukko01 from '../../assets/images/konosuba/zuko/01.png';
import bakuenzukko02 from '../../assets/images/konosuba/zuko/02.jpg';
export {bakuenzukko01, bakuenzukko02 }

function SOBakuenZukko(props) {

    const Titulo = "Kono Subarashii Sekai ni Bakuen wo! Zukko"
    const linkNav = "bakuenzukko"
            ...
            <Container className="bg-white border">
                <Row className="justify-content-center py-5">
                    ...
                    <Col lg={3} md={4} sm={6} xs={6}>
                        <ModalImage className="ln-cover" small={bakuenzukko02} large={bakuenzukko02} alt={`${Titulo} Volumen 02`} />
                        <Card.Body>
                    ...
                    <Col lg={3} md={4} sm={6} xs={6}>
                        <ModalImage className="ln-cover" small={bakuenzukko01} large={bakuenzukko01} alt={`${Titulo} Volumen 01`} />
                        <Card.Body>
